<% if $SiteConfig.SocialInstagram %>
    <a href="$SiteConfig.SocialInstagram" rel="nofollow noopener" target="_blank"
       ...
       title="<%t Template.FooterInstaLinkTitle 'Link to our Instagram page'%>">
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" aria-labelledby="footerlogo-insta">
            <title id="footerlogo-insta"><%t Template.InstagramLogo 'Instagram Logo' %></title>
            <style>svg {
                fill: #000000
            }</style>
    ...
    <a href="$SiteConfig.SocialX" rel="nofollow noopener" target="_blank"
       ...
       title="<%t Template.FooterXLinkTitle 'Link to our X feed'%>">
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" aria-labelledby="footerlogo-x">
            <title id="footerlogo-x"><%t Template.XLogo 'X Logo' %></title>
            <style>svg {
                fill: #000000
            }</style>
...
<% if $SiteConfig.SocialLinkedIn %>
    <a href="$SiteConfig.SocialLinkedIn" rel="nofollow noopener" target="_blank"
       ...
       title="<%t Template.FooterLinkedInLinkTitle 'Link to our Linked in page'%>">
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" aria-labelledby="footerlogo-linkedin">
            <title id="footerlogo-linkedin"><%t Template.LinkedInLogo 'Linked in Logo' %></title>
            <style>svg {
                fill: #000000
            }</style>
...
<% if $SiteConfig.SocialYoutube %>
    <a href="$SiteConfig.SocialYoutube" rel="nofollow noopener" target="_blank"
       ...
       title="<%t Template.FooterYouTubeLinkTitle 'Link to our Youtube page'%>">
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" aria-labelledby="footerlogo-youtube">
            <title id="footerlogo-youtube"><%t Template.YouTubeLogo 'Youtube Logo' %></title>
            <style>svg {
                fill: #000000
            }</style>
...
<% if $SiteConfig.SocialFacebook %>
    <a href="$SiteConfig.SocialFacebook" rel="nofollow noopener" target="_blank"
       ...
       title="<%t Template.FooterFacebookLinkTitle 'Link to our Facebook page'%>">
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512" aria-labelledby="footerlogo-facebook">
            <title id="footerlogo-facebook"><%t Template.FacebookLogo 'Facebook Logo' %></title>
            <style>svg {
                fill: #000000
            }</style>
